...
Once finished, you will be taken to the `get_cluster_storage_details` function page. There's a lot of menu items on th is page - don't be alarmed! We're going to come back to this page in a moment.
...
![Test Content for get_cluster_storage_details](/docs/images/get-cluster-status-test-content.jpg)
